...
{
    public partial class AllTimmingAutoBetForm : Form
    {
        private Thread _executeThread;

        public AllTimmingAutoBetForm()
        {
            InitializeComponent();
        }

        private void AllAutoBet_Load(object sender, EventArgs e)
        {
        ...
        private void AllAutoBet_FormClosing(object sender, FormClosingEventArgs e)
        {
