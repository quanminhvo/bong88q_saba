...
{
    public partial class AddBetByHdpPriceForm : Form
    {
        private long _matchId;

        public AddBetByHdpPriceForm(long matchId)
        {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (DataStore.Matchs.TryGetValue(_matchId, out match))
            {
                ...
                DataStore.BetByHdpPrice.Add(new Models.DataModels.BetByHdpPrice()
                {
                    ...
                    UpToMinute = (int)numMinute.Value,
        ...
        private void LoadMainGrid()
        {
            ...
            List<Models.DataModels.BetByHdpPrice> betsOfThisMatch = DataStore.BetByHdpPrice
        ...
        private void AddBetByHdpPriceForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnDeleteAll_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                DataStore.BetByHdpPrice.RemoveAll(item => item.MatchId == this._matchId);
                LoadMainGrid();
            }
        }
    }
